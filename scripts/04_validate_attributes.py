...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Executa apenas validação atributiva sobre a última run ou uma run indicada.")
    ...
    print(f"Erros atributivos: {len(issues)}")
    print(f"Run: {run_dir}")
    return 0
