...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Executa a pipeline completa de validação de água.")
    ...
    run_dir = run_full_pipeline(args.config, domain_default="AGUA", skip_extract=args.skip_extract)
