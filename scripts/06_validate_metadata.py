...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Executa apenas validação de metadados sobre a última run ou uma run indicada.")
    ...
    print(f"Erros de metadados: {len(issues)}")
    print(f"Run: {run_dir}")
    return 0
